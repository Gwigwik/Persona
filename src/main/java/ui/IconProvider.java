...
public class IconProvider {
    ...
    public static AnimatedSprite getAnimatedCharacterIcon(entities.Character character, int frameCount, int frameWidth, int frameHeight, int size, int duration) {
        Image spriteSheet = ResourceLoader.loadImage("/images/characters/" + (character.getFileName()!= null?character.getFileName():"noCharacter") + ".png");
    ...
    public static AnimatedSprite getAnimatedCommonIcon(String spriteName, int frameCount, int frameWidth, int frameHeight, int size, int duration) {
        Image spriteSheet = ResourceLoader.loadImage("/images/common/" + spriteName + ".png");
        AnimatedSprite sprite = new AnimatedSprite(spriteSheet, frameCount, frameWidth, frameHeight, duration);
        sprite.getView().setFitWidth(size);
        sprite.getView().setFitHeight(size);
        return sprite;
    ...
    public static ImageView getCommonIcon(String imageName, int size) {
        Image image = ResourceLoader.loadImage("/images/common/" + imageName + ".png");
        ImageView view = new ImageView(image);
        view.setFitWidth(size);
        view.setFitHeight(size);
        return view;
